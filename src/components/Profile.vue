      ...
      <v-container fill-height>
        <v-layout align-center>
          <v-flex xs12 sm6 offset-sm3>
            <v-card>
              <v-card-media :src="imgUrl" height="300px" contain>
...
export default {
  data: () => ({
    imgUrl: '/home/jared/mevn-stack-vue-2/src/assets/logo.png',
    valid: true,
    ...
    image: null,
    imageUrl: '/home/jared/mevn-stack-vue-2/src/assets/logo.png'
  }),
  computed: {
    compareEmails () {
